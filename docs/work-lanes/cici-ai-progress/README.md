...
- [ ] Collect GitHub + country from: Jiyah, Ythak Pat, Y, Diwitty|, Bj Libron (not yet introduced)
- [ ] Get GitHub URL + country for Val Ortiz and Jiaji (jiaj259) — fork confirmed but intro details not yet in tracker
...
- [ ] Confirm which exec-report handles map to: Jiyah, Ythak Pat, Y, Bj Libron (Mia-yana, Chloe05688 still unmatched)
...
| Jiaji | — | [jiaj259](https://github.com/jiaj259) [C] | Fork confirmed [A]; likely jiaj259 from exec report; GitHub URL + country still needed |
...
_jiaj259 mapped to Jiaji based on name similarity — owner to confirm._
...
_Mia-yana and Chloe05688 are in the executive report but not yet matched to a Telegram member. Likely among the unintroduced members (Jiyah, Ythak Pat, Y, Bj Libron). jiaj259 is tentatively mapped to Jiaji — owner to confirm._
